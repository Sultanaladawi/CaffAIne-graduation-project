...
function Tags({ tags = [], linkedTags = [] }) {
  ...
  const getTagConfig = (name) => {
    ...
    if (lower.includes('soda') || lower.includes('soft') || lower.includes('cola') || lower.includes('pepsi') || lower.includes('sprite'))
      return { gradient: 'linear-gradient(135deg, #ef4444, #991b1b)', border: '#fca5a5', color: '#fef2f2', emoji: '🥤' };
