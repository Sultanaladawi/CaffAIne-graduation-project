        ...
        <div>
          ...
          <div style={{ display: 'inline-block', padding: '10px 18px', borderRadius: '12px', background: 'rgba(255,255,255,0.03)', marginBottom: '15px' }}>
            <h2 style={{ display: 'flex', alignItems: 'center', gap: '15px', margin: 0, color: 'var(--admin-text)', fontSize: '2.2rem', fontFamily: "'DM Serif Display', serif", fontWeight: 700 }}>
              <BsGrid3X3 size={32} color={colors.crema} /> Product Management
            </h2>
          </div>
                  ...
                  <tr key={item.id} className="product-row"
                    ...
                    <td style={{ padding: '16px 12px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '8px', background: 'linear-gradient(135deg, #c7a57a 0%, #a47c4f 100%)', color: colors.espresso, fontWeight: 900, letterSpacing: '1px', boxShadow: '0 4px 10px rgba(196, 164, 132, 0.3)' }}>
                          PRD-{String(index + 1).padStart(3, '0')}
                        </span>
                      </div>
                    </td>
